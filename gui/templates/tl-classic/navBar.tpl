...
<body class="navigationBar" style="min-width: 800px;background: #436bb3;border-bottom-color: #596885;">
<div style="float:left; margin:20px 0 0 8px;">
  <a href="index.php" target="_parent" style="float:left; text-decoration:none;">
  <img alt="Company logo" title="logo" style="height: 30px; width: auto; vertical-align: middle;" src="{$smarty.const.TL_THEME_IMG_DIR}{$tlCfg->logo_navbar}" />
  </a>
</div>
...
<div class="qa_wordmark" style="clear:both; background:#ffffff; border-top:1px solid #596885; position:absolute; left:0; right:0; top:70px; bottom:0;">
  <div style="padding:4px 0 6px 10px;">
    <div class="qa_line1">Quality</div>
    <div class="qa_line2">Assurance</div>
  </div>
</div>
